...
export const menuFactory = (x, y, menuItems, data, svgId) => {
    ...
    console.log(x + ". " + y + ". " + menuItems + ". " + data + ". " + svgId + ". " )
...
export const createContextMenu = (event, d, menuItems, width, height, svgId) => {
    menuFactory(event.clientX, event.clientY-100, menuItems, d, svgId);
    console.log(event)
